...
|-------------|-------------------|-----------|
| EICR (electrical safety) | Yes — since July 2020 | Every 5 years |
| Gas Safety Certificate (CP12) | Yes — if property has gas | Annually |
| EPC (energy performance) | Yes — rated E or above | Every 10 years |
