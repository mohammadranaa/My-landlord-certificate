...
export const metadata: Metadata = {
  ...
  description:
    "PAT Testing from £59.99 for up to 10 appliances. Pass/fail labels, digital asset register, certificate within 24 hours. Book today.",
  alternates: { canonical: "https://www.mylandlordcertificate.co.uk/pat-testing" },
  openGraph: {
    title: "PAT Testing from £59.99 | Digital Certificate Within 24 Hours",
    description:
      "PAT Testing from £59.99 for up to 10 appliances. Pass/fail labels, digital asset register, certificate within 24 hours. Book online today.",
      ...
      <div className="bg-spec-bar text-sm py-5 border-t-2 border-action-green">
        <Container>
          <dl className="grid grid-cols-2 gap-x-4 gap-y-5 text-center [&>*:last-child:nth-child(odd)]:col-span-2 md:flex md:flex-wrap md:items-center md:justify-center md:gap-y-3 md:text-left text-white/70">
            ...
            <div className="flex flex-col gap-1 md:border-l md:border-white/15 md:px-6 md:first:border-l-0 md:first:pl-0">
              <dt className="text-[11px] font-medium uppercase tracking-wider text-white/50">Covers</dt>
              <dd className="text-sm font-bold text-white">up to 10 appliances</dd>
            </div>
            <div className="flex flex-col gap-1 md:border-l md:border-white/15 md:px-6 md:first:border-l-0 md:first:pl-0">
            ...
            <div className="flex flex-col gap-1 md:border-l md:border-white/15 md:px-6 md:first:border-l-0 md:first:pl-0">
              <dt className="text-[11px] font-medium uppercase tracking-wider text-white/50">Includes</dt>
              <dd className="text-sm font-bold text-white">digital asset register</dd>
            </div>
          </dl>
        </Container>
      </div>
