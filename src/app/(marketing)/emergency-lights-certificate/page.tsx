...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We cover all 33 London boroughs including Westminster, Camden, Islington, Hackney, Southwark, Lambeth, Tower Hamlets, Wandsworth, and all other boroughs. A congestion zone supplement of £20 applies for properties within the TfL congestion zone.",
  },
];
      ...
      <div className="bg-spec-bar text-white border-t-2 border-action-green">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-5">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:divide-x md:divide-white/10">
            ...
            <div className="pl-4">
              <p className="text-[11px] font-medium uppercase tracking-wider text-white/50 mb-0.5">Required</p>
