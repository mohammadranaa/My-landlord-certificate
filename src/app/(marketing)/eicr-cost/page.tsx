        ...
        <Container>
          <dl className="flex flex-wrap gap-x-8 gap-y-1 text-brand-grey">
            <div className="flex gap-1.5">
              <dt>Studio</dt>
              <dd className="text-white font-semibold">£{lowestDomesticPrice}</dd>
            </div>
            <div className="flex gap-1.5">
              <dt>1–3 bed</dt>
              <dd className="text-white font-semibold">£{popularDomesticPrice}</dd>
            </div>
            <div className="flex gap-1.5">
              <dt>Commercial from</dt>
              <dd className="text-white font-semibold">£149.99</dd>
            </div>
            <div className="flex gap-1.5">
              <dt>Valid</dt>
