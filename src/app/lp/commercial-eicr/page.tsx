...
export const metadata: Metadata = {
  ...
  description:
    "Commercial EICR from £149.99. NICEIC approved contractors across London and the M25 area, fixed pricing. Get a quote today.",
...
const serviceSchema = {
  ...
  description:
    "Commercial EICR from £149.99. NICEIC approved contractors inspect all circuits and fixed wiring. Get a quote today.",
    ...
    <>
      ...
      <div className="bg-spec-bar text-white border-t-2 border-action-green">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 grid grid-cols-2 md:grid-cols-4 gap-3 text-center text-sm">
          <div><span className="font-bold">From £{entryPrice}</span><br /><span className="text-white/60 text-[11px] uppercase tracking-wider">Per consumer unit</span></div>
          <div><span className="font-bold">Within 24 hours</span><br /><span className="text-white/60 text-[11px] uppercase tracking-wider">Certificate emailed</span></div>
          ...
          <div><span className="font-bold">NICEIC approved</span><br /><span className="text-white/60 text-[11px] uppercase tracking-wider">Industry gold standard</span></div>
        </div>
      </div>
