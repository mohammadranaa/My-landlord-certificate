...
const reviews = [
  {
    content:
      "Booked a fire safety certificate for my flat before new tenants moved in. The engineer tested every smoke and heat alarm, replaced one that had expired and emailed the certificate the same day. Simple and quick.",
    author: "Daniel R.",
    location: "Lewisham",
  },
  {
...
const steps = [
  { n: "1", title: "Book online or call", body: "Tell us the property and how many alarms, then pick a date. Same-week slots across all 33 London boroughs." },
  { n: "2", title: "Engineer tests your alarms", body: "An accredited engineer tests every smoke, heat and CO alarm, checks placement and interlinking, and replaces any that have expired." },
  { n: "3", title: "Certificate in 24 hours", body: "We email your fire safety certificate, confirming your alarms are present and working, ready to share with tenants." },
];
...
const stepIcons = [
  ...
  <svg key="2" className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9" /><path d="M12 8v4M12 16h.01" /></svg>,
...
const faqs = [
  {
    q: "Is a fire safety / smoke alarm certificate a legal requirement?",
    a: "The Smoke and Carbon Monoxide Alarm (England) Regulations 2015, amended in October 2022, require landlords to fit and maintain at least one smoke alarm on every storey used as living accommodation, plus a carbon monoxide alarm in any room with a fixed combustion appliance. A fire safety certificate documents that these alarms are present and working at the start of the tenancy.",
  },
  {
    q: "What does the engineer test?",
    a: "Every smoke alarm, heat alarm and carbon monoxide alarm in the property — placement on each storey, operation via the test button, interlinking where fitted, and expiry dates. Any expired or faulty alarm can be replaced on the visit.",
  },
  {
    q: "How quickly do I get the certificate?",
    a: "We email your fire safety certificate within 24 hours of the visit, ready for your records and to share with your tenants.",
  },
  {
    q: "What alarms do I need as a landlord?",
    a: "At least one smoke alarm on every storey used as living accommodation, and a carbon monoxide alarm in any room with a fixed combustion appliance such as a gas boiler or wood burner. Gas cookers are exempt from the CO alarm requirement. We will advise if anything is missing.",
  },
];
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <div>
              <p className="text-blue-200 text-sm font-semibold uppercase tracking-widest mb-4">
                Accredited Engineers · All 33 London Boroughs · 24-Hour Certificate
              </p>
              <h1 className="text-3xl lg:text-5xl font-bold leading-tight mb-4">
                Fire Safety Certificate in London from £{entryPrice}
              </h1>
              ...
              <p className="text-blue-100 text-lg leading-relaxed mb-6 max-w-xl">
                The smoke and heat alarm testing landlords need under the Smoke and Carbon
                Monoxide Alarm Regulations. Certificate within 24 hours. Fixed price, no hidden fees.
              </p>
              <div className="flex flex-wrap gap-3 mb-3">
                <Link href={BOOK} className="inline-flex items-center bg-action-green hover:bg-green-500 text-brand-charcoal font-semibold px-6 py-3 rounded-xl transition-colors">
                  Book my certificate, from £{entryPrice}
                </Link>
      ...
      <section className="bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-14">
          ...
          <h2 className="text-2xl font-bold text-brand-charcoal mb-10 text-center">Compliant, fast and landlord-ready</h2>
      ...
      <section className="bg-warm-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-14 grid md:grid-cols-2 gap-10 items-center">
          <Image
            ...
            alt="Ceiling-mounted smoke and heat alarm being tested by an engineer"
            width={1200}
            height={800}
          ...
          />
          <div>
            <p className="text-sm font-semibold uppercase tracking-widest text-compliance-blue mb-2">A proper test</p>
            <h2 className="text-2xl font-bold text-brand-charcoal mb-4">Every alarm, tested and certified</h2>
            <p className="text-brand-charcoal/80 leading-relaxed mb-5">
              Your engineer checks every alarm in the property, confirms it is in the right
              place and working, and replaces anything that has expired.
            </p>
            <ul className="space-y-2.5">
              {[
                "A smoke alarm on every storey",
                "Heat alarms in kitchens where fitted",
                "CO alarms by combustion appliances",
                "Test-button, interlink and expiry checks",
              ].map((t) => (
      ...
      {/* Job gallery — only the two photos that genuinely apply to a fire safety certificate */}
      <section className="bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-14">
          <h2 className="text-2xl font-bold text-brand-charcoal mb-2 text-center">From a recent London job</h2>
          <p className="text-brand-grey text-center mb-8 max-w-xl mx-auto">Real photos from our engineers. Click any image to enlarge.</p>
          <ImageSlider
            images={[
              { src: "/fire-risk-assessment/jobs/fra-job-smoke-alarm.jpg", alt: "Ceiling-mounted smoke and heat alarm checked and tested", title: "Smoke & heat alarm check", caption: "Placement, operation and expiry checked on every alarm.", badge: "FSC" },
              { src: "/fire-risk-assessment/jobs/fra-job-fire-door.jpg", alt: "Fire door inspected as part of the property's fire safety", title: "Fire door check", caption: "Seals, closers and gaps checked where fire doors are fitted.", badge: "FSC" },
            ]}
          />
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-14 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="w-full max-w-[360px] mx-auto rounded-2xl border border-border shadow-md overflow-hidden bg-white">
            <div className="bg-hero-blue text-white px-6 py-7 text-center">
              ...
              <p className="font-bold text-lg leading-tight">Fire Safety Certificate</p>
              <p className="text-blue-100 text-[11px] mt-1 uppercase tracking-[0.15em]">Smoke &amp; Heat Alarm Test Record</p>
            </div>
            <div className="px-6 py-5">
              <ul className="space-y-3">
                {[
                  "All alarms tested and passing",
                  "Issued within 24 hours",
                  "Emailed to you as a PDF",
                  "Landlord-ready, all 33 boroughs",
                ].map((t) => (
                  <li key={t} className="flex items-center gap-3 text-sm text-brand-charcoal/85">
                    <span className="w-5 h-5 rounded-full bg-action-green/15 text-action-green flex items-center justify-center shrink-0 text-xs font-bold">✓</span>
                    {t}
                  </li>
                ))}
              </ul>
              <div className="mt-5 pt-4 border-t border-border flex items-center justify-between">
                <span className="text-xs uppercase tracking-widest text-brand-grey">Result</span>
                <span className="inline-flex items-center gap-1.5 text-action-green font-bold text-sm">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M20 6L9 17l-5-5" /></svg>
                  Pass
                </span>
              </div>
            </div>
          ...
          <div>
            ...
            <h2 className="text-2xl font-bold text-brand-charcoal mb-4">A clear, tenant-ready certificate</h2>
            <ul className="space-y-2.5">
              {[
                "Fire safety (smoke &amp; CO alarm) certificate",
                "Every alarm listed, with location and status",
                "Confirmation each alarm was tested and working",
                "Any replacements carried out on the visit",
      ...
      <section className="bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-14">
          <h2 className="text-2xl font-bold text-brand-charcoal mb-2 text-center">Fixed fire safety certificate pricing</h2>
          <p className="text-brand-grey mb-6 text-center">By number of alarms. Includes the on-site testing and the certificate.</p>
          <PriceTable title="Fire Safety Certificate" rows={FIRE_SAFETY_CERT_TABLE} highlightCheapest />
          <p className="text-sm text-brand-grey mt-4 text-center">
            Larger buildings or many alarms? Call {PHONE_DISPLAY} for a fixed quote.
          </p>
      ...
      <section className="bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-14">
          ...
          <p className="text-brand-grey text-center mb-8 max-w-xl mx-auto">
            Accredited engineers across all 33 London boroughs and the surrounding M25 area,
          ...
          <GoogleReviews
            fallback={
              <div className="grid sm:grid-cols-2 gap-5 max-w-3xl mx-auto">
                {reviews.map((r) => (
                  <TestimonialCard key={r.author} content={r.content} author={r.author} location={r.location} service="Fire Safety Certificate" />
                ))}
              </div>
            }
          />
      ...
      <section className="bg-warm-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
          ...
          <p className="text-brand-grey text-center mb-6 max-w-xl mx-auto">
            134 Merton High St, London SW19 1BA. Accredited engineers covering all 33 London
      ...
      <section className="bg-hero-blue text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14 text-center">
          ...
          <p className="text-blue-100 mb-7 max-w-lg mx-auto">
            Accredited engineers across all 33 London boroughs. Smoke and heat alarm testing
            with your certificate within 24 hours. Fixed price, no hidden fees.
          </p>
