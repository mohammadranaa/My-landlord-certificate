...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Commercial FRA pricing lives on the residential page itself
      // (see the fire-risk-assessment/page.tsx history) rather than a
      // separate page — this redirect is permanent, not a stopgap.
